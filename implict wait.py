...
print(driver.title)
driver.find_element(By.NAME,"customerName").send_keys("vikas")
driver.find_element(By.ID,"ap_phone_number").send_keys("9160673390")
driver.find_element(By.NAME,"secondaryLoginClaim").send_keys("vikas@gmail.com")
driver.find_element(By.NAME,"password").send_keys("vikas12")
